...
function initSdk(name) {
    ...
    const chatWidgetSettings = {
        URI: '',                               // ODA URI, only the hostname part should be passed, without the https://
        ...
        channelId: '',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
        ...
        width:  '440px',                            // Setting custom height because of the hidden user input
        enableSpeech: true,                         // Enables voice recognition
        initUserProfile: {
            profile: {
                channelType: 'websdkOutsidePS'
                }
        },
